...
CDR_PATH = os.path.abspath(
    os.path.join(
        ...
        "convection_diffusion_reaction_system_code",
    )
)
...
def main():
    ...
    output_path = os.path.abspath("docs/source/demos/notebooks/eki_mf_eki_demo.png")
    plt.tight_layout()
