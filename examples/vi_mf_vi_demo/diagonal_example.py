"""VI versus MF-VI for the diagonal analytic sine posterior."""
...
def main(
    ...
    """Run the equispaced-observation diagonal-posterior example."""
    ...
    root = (
        ...
        if work_dir
        else Path(__file__).parent / "diagonal_work"
    )
    ...
    write_convergence_plot(
        output / "analytic_sine_diagonal_convergence.png",
        vi_history,
        mf_history,
        "Equispaced observations: convergence to the exact posterior",
    )
    write_mean_plot(
        output / "analytic_sine_diagonal_mean.png",
        problem,
        vi_history,
        mf_history,
        "Equispaced observations: posterior mean",
    )
    write_diagonal_posterior_plot(
        output / "analytic_sine_diagonal_posterior.png",
        problem,
        vi_history,
        mf_history,
    )
