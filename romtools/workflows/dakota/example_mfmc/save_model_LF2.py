...
class PDA_Model_LF2(rt.workflows.models.QoiModel):
    def __init__(self):
        print("Initializing LF2")
    ...
    def run_model(self, run_directory, parameter_sample):
        ...
        os.system('python ' + run_directory + '/../../model_LF2.py')
...
if __name__ == "__main__":
    # Define model
    fom_model = PDA_Model_LF2()
    with open('LF2.pickle', 'wb') as handle:
