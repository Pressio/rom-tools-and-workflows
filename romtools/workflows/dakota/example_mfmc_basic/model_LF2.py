...
meshObj = pda.load_cellcentered_uniform_mesh(path_to_file + "/mesh_LF2")
x = meshObj.viewX()
y = meshObj.viewY()
...
def residual(u):
    problem.rightHandSide(u,0.,f)
    return f

u = scipy.optimize.newton_krylov(residual, u, verbose=4, maxiter=20, f_tol=1e-2)
