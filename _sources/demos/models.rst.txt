...
The first examples demonstrate the model interfaces. The CDR, hydrogen-air
flame, and nonlinear solid-dynamics examples document reusable application
models used throughout the workflow demonstrations.
